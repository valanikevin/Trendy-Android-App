...
import com.aiora.trendy.providers.woocommerce.WooCommerceTask;
import com.aiora.trendy.providers.woocommerce.adapter.ProductsAdapter;
import com.aiora.trendy.providers.woocommerce.checkout.CartAssistant;
import com.aiora.trendy.providers.woocommerce.checkout.PriceFormat;
import com.aiora.trendy.providers.woocommerce.model.RestAPI;
import com.aiora.trendy.providers.woocommerce.model.products.Attribute;
import com.aiora.trendy.providers.woocommerce.model.products.Category;
import com.aiora.trendy.providers.woocommerce.model.products.Image;
import com.aiora.trendy.providers.woocommerce.model.products.Product;
import com.aiora.trendy.providers.woocommerce.model.products.Tag;
import com.aiora.trendy.util.DetailActivity;
import com.aiora.trendy.util.Helper;
import com.aiora.trendy.util.InfiniteRecyclerViewAdapter;
import com.aiora.trendy.util.WebHelper;
...
public class ProductActivity extends DetailActivity {
    ...
    private void loadRating(){
        ...
        if (product.getRatingCount() > 0) {
            ...
            ((TextView) findViewById(R.id.rating_numeric)).setText(
                    product.getAverageRating());
        } else {
            findViewById(R.id.rating_box).setVisibility(View.GONE);
        }
    }
    ...
    private void loadRelated(){
        ...
        WooCommerceTask.Callback<Product> callback = new WooCommerceTask.Callback<Product>() {
            ...
            public void success(ArrayList<Product> result) {
                TextView relatedTitle = findViewById(R.id.related_title);
