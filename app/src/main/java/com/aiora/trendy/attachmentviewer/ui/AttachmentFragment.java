package com.aiora.trendy.attachmentviewer.ui;
...
import com.aiora.trendy.attachmentviewer.loader.DefaultImageLoader;
import com.aiora.trendy.attachmentviewer.loader.MediaLoader;
import com.aiora.trendy.attachmentviewer.loader.PicassoImageLoader;
import com.aiora.trendy.attachmentviewer.model.MediaAttachment;
import com.aiora.trendy.attachmentviewer.widgets.HackyViewPager;
import com.aiora.trendy.attachmentviewer.widgets.ScrollGalleryView;
...
public class AttachmentFragment extends Fragment {
    ...
    private void createViewAttacher(Bundle savedInstanceState) {
        if (savedInstanceState.getBoolean(ZOOM)) {
            Log.v("INFO", "Attaching zoom stuff");
